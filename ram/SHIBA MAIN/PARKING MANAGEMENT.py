# ================ Library importing ===============================#shibansumandal@gmail.com
                ...
                if etrdb:
                    ...
                    for i in fooddic.keys():
                        if l < len(i):
                            l = len(i)
                    l += 3
                    a.insert(END, "\t\t  PARKING MANAGEMENT SYSTEM \t\t\t" + "\n")
    ...
    def srch_date(a, x, y, d, fm):
        ...
        if sc == '':
            ...
            if not data:
                ...
                cusdbtbl.heading("one", text="Customer Name", anchor=W)
                cusdbtbl.heading("two", text="Phone Number", anchor=W)
                cusdbtbl.heading("three", text="Vehicle no.", anchor=W)
                cusdbtbl.heading("four", text="Slip Number", anchor=W)
                cusdbtbl.heading("five", text="Date", anchor=W)
                cusdbtbl.heading("six", text="Total Cost", anchor=W)
                cusdbtbl.pack(side=TOP)
...
def update_item(l, ch, ed):
    if ed:
        if ch:
            ...
            footit = Label(frminp, text='CAR NAME \t   : ', font=('Eras Demi ITC', 22, 'bold'), bg='snow3')
            footit.grid(row=0, column=0, sticky=W, pady=10)
            ratetit = Label(frminp, text='RATE/HOUR\t   : ', font=('Eras Demi ITC', 22, 'bold'), bg='snow3')
            ratetit.grid(row=1, column=0, sticky=W, pady=10)
            regtit = Label(frminp, text='COLOUR \t   : ', font=('Eras Demi ITC', 22, 'bold'), bg='snow3')
...
def fooddb_tble(a, b, c, edtdb):
    ...
    cusdbtbl.heading("#0", text="Sl.No.", anchor=W)
    cusdbtbl.heading("one", text="CAR NAME", anchor=W)
    cusdbtbl.heading("two", text="RATE PER HOUR", anchor=W)
    cusdbtbl.heading("three", text="COLOUR", anchor=W)
...
def add_food():
    ...
    tit = Label(frminf, text='ADD NEW CAR', font=('Viner Hand ITC', 32, 'bold'), bg='saddle brown')
    tit.grid(padx=115, pady=25)
    ...
    savebtn = Button(frmbtn, text='ADD CAR', width=14, font=('Yu Gothic UI Semibold', 18, 'bold'),
...
def edit_any_db(val, a, z, c, pwd, x):
    ...
    if val == 0:
        ...
        btn1 = Button(btnfuncfrm, text='ADD CAR ', height=1, width=20,
...
def mainwindow(pi):
    ...
    lblTitle = Label(titframe, font=('Segoe UI', 30, 'bold'), text="PARKING MANAGEMENT SYSTEM",
    ...
    lblfoodtitfrm = Label(foodtitfrm, font=('Lucida Fax', 15, 'bold'),
                          text='SELECT CARS ', bg='gray20', fg='chocolate3', justify=CENTER)
    ...
    prntbtn.grid(row=0, column=2,pady=5)
    ...
    slp = Label(cus1, text="SLIP NO.      :     ", font=('Gabriola', 22, 'bold'), bg='SLATEBLUE2')
    ...
    dte = Label(cus1, text="DATE\t     :     ", font=('Gabriola', 22, 'bold'), bg='SLATEBLUE2')
    ...
    nam = Label(cus1, text="NAME\t     :     ", font=('Gabriola', 22, 'bold'), bg='SLATEBLUE2')
    ...
    pno = Label(cus1, text="PHONE NO.    :     ", font=('Gabriola', 22, 'bold'), bg='SLATEBLUE2')
    ...
    adres = Label(cus1, text="VEHICLE NO.      :     ", font=('Gabriola', 22, 'bold'), bg='SLATEBLUE2')
    ...
    fodregion = Label(food1, text='CARS LIST \t: ', font=('Times New Roman', 20, 'bold'), bg='gold')
    ...
    foditem = Label(food1, text='SELECT CAR DETAILS  \t: ', font=('Times New Roman', 20, 'bold'), bg='gold')
    ...
    rateLabel = Label(food1, text='RATE PER HOUR     \t: ', font=('Times New Roman', 20, 'bold'), bg='gold')
    ...
    quantityLabel = Label(food1, text='HOURS TO BE PARKED \t: ', font=('Times New Roman', 20, 'bold'), bg='gold')
